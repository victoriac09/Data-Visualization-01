...
color_set = ['#e74c3c', 'darkblue', 'brown', 'darkgreen', 'lime', 'cyan', 'deeppink']
fig = px.scatter_mapbox(Business_format, 
                        lat="latitude",
                        lon="longitude", hover_name="Format Category", 
                         hover_data=[ "stars","review_count","Business Status","City",'Number of Museum nearby ',
                     ' Number of Cinemas nearby',' Number of Beach nearby','Number of ShoppingMall nearby'],
                        zoom=9, height=300, color="Format Category", size_max=20,
                        center=dict(lat=27.964157, lon=-82.452606),
                        size="review_count", 
                        color_discrete_sequence=color_set)

fig.update_layout(mapbox_style="open-street-map")
fig.update_layout(title="<b>Distribution of Restaurants' by Count of Reviews & Format Category</b> ", title_font=dict(size=14))
...
fig.write_html("../../website/img/Geo_Format_Reviews.html")
